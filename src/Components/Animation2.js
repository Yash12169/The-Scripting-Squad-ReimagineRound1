...
function Animation2() {
    ...
    return (
        <div className="anim2 w-screen h-screen ">


            <div>
                <div className="montserrat-thick-2 text-[em] text-[#1D2951] ml-[30px] mr-[30px] mt-[30px] mb-[30px]">
                    <div className={'mb-[10px]'}>
                        <TextRevealStag text={'Introducing Rizta'}/>
                    </div>
                    <TextRevealStag text={'with love and innovation'}/>
